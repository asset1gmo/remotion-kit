 ...
 */
export { compressAnimation, buildAnimations, type AnimationConfig, type CompressOptions, type CompressResult, type BuildAnimationsOptions, } from "./compressor/compress.js";
export { BUNDLE_FORMAT, ASSET_MODULE, RUNTIME_EXTERNALS, type AnimationManifest, type AnimationMeta, } from "./core/manifest.js";
