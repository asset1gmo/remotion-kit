...
export declare const BUNDLE_FORMAT = 1;
/**
 ...
 */
export declare const ASSET_MODULE = "@asset1gmo/remotion-kit/asset";
/** External specifiers an animation bundle is allowed to `require` at load. */
export declare const RUNTIME_EXTERNALS: readonly ["react", "react-dom", "react/jsx-runtime", "remotion", "@asset1gmo/remotion-kit/asset"];
/**
